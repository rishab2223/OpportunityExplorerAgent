...
| `gpa_10_point`, `gpa_5_point` | the same grade on both scales, because a form asks for one or the other and converting on the spot is how a 7.4 becomes a 7.4 out of 5. Filled **only where the form makes it mandatory** |
